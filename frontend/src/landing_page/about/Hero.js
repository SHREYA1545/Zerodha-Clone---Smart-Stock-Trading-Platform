    ...
    return (
        <>
            <div className='container p-5 mb-5 mt-5'>
                <h1 className='row fs-3 text-center'>We pioneered the discount broking model in India.
                    <br />
...
<br/><br/>
                        And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is saying about us or learn more about our business and product <a href='' style={{textDecoration : "none"}}>philosophies </a>.
                    </p>
                </div>
